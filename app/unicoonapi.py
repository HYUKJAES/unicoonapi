...
# GPT 프롬프트 생성
PROMPT_TEMPLATE = '''너는 목표 관리 전문가야\n내가 키워드 하나 줄테니까 키워드와 연관 지어서 아래 내용들을 만들어줘\n\n* 공통내용\n모든 내용은 개조식으로 해줘\n맨 앞에 이모티콘 하나씩 넣어줘\n센스 있는 문구들로 구성해줘\n최대한 간략하게 핵심 단어만 써줘\n\n1. 인생 사명, 미션을 한 줄로 정의해줘\n- 간결하게 20자를 넘지 않도록 해줘\n\n2. 앞에서 정한 인생 사명,미션을 달성하기 위한 목표를 2개 나열해줘\n- 목표는 막연한 것 말고 정량적 표시가 가능하고 장기적으로 실천해야하는 항목으로 적어줘\n\n3. 위에서 정한 목표를 달성하기 위한 루틴, 투두를 3개만 나열해줘\n- 최대한 간략하게 적어줘\n\n이 내용들을 Json 형태로 만들어서 리턴시킬거야\n```json 같은 구분 문자나 이상한 특수문자는 모두 제외하고 리턴시켜줘\n\n키워드: {keyword}'''
